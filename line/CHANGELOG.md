...
- Changed to test the scenario - 2 changelogs are updated for the same package.
- Expected:
  - changes to this file should not be considered.
  - Only `packages/com.google.ads.mobile.mediation.line/CHANGELOG.md` should be used.
  - A release should be made with v1.0.9 as updated in the package changelog file.
